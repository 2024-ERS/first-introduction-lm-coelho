...
```{r}
# define a variable A amd assign tha value 5 to 1t
A <- 5
...
mean(my_numbers)
base::mean(my_numbers) #use function from package base (except when it comes from base = default)
...
print(randomvalue) # print the random values generated
mean(randomvalue) # prove that the mean is close to 0

data1<-data.frame(randomvalue)
# plot as a histogram
print(data1) # print data frame
